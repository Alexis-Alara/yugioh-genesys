// Genesys format point values for Yu-Gi-Oh cards
export class GenesysService {
  private static genesysPoints: Map<string, number> = new Map([
    ["Abyss Dweller", 100],
    ["Adamancipator Risen - Dragite", 20],
    ["Agido the Ancient Sentinel", 50],
    ["Albion the Sanctifire Dragon", 33],
    ["Albion the Branded Dragon", 20],
    ...
    ["Give and Take", 91],
    ["Gladiator Beast Gyzarus", 0],
    ["Gladiator Beast Tamer Editor", 33],
    ["Gladiator Proving Ground", 25],
    ["Gladiator Rejection", 10],
    ["Glow-Up Bulb", 21],
    ...
    ["Mass Driver", 100],
    ["Master Peace, the True Draceslaying King", 33],
    ["Mathmech Sigma", 7],
    ["Maxx \"C\"", 50],
    ["Megalith Anastasis", 33],
    ["Meizen the Battle Ninja", 5],
    ...
    ["Tenyi Spirit - Ashuna", 13],
    ["Terraforming", 33],
    ["That Grass Looks Greener", 50],
    ["The Black Goat Laughs", 10],
    ["The Bystial Lubellion", 30],
    ["The Dragon that Devours the Dogma", 10],
    ["The Fallen & The Virtuous", 15],
  ...
  /**
   * Get the Genesys point value for a card by name
   */
  static getCardPoints(cardName: string): number {
    return this.genesysPoints.get(cardName) || 0;
  }

  /**
   * Check if a card has Genesys points assigned
   */
  static hasGenesysPoints(cardName: string): boolean {
    return this.genesysPoints.has(cardName);
  }

  /**
   * Get all cards with Genesys points
   */
  static getAllGenesysCards(): string[] {
    return Array.from(this.genesysPoints.keys());
  }
